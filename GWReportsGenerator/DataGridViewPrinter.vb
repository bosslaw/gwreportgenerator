...
Module DataGridViewPrinter
    ...
    Private lStringFormat As StringFormat
    ...
    Private IsInLandscape As Boolean

    Public Sub StartPrint(ByVal GridToPrint As DataGridView, ByVal PrintAsLandscape As Boolean, ByVal ShowPrintPreview As Boolean, ByVal HeaderToPrint As String)
        ...
        IsInLandscape = PrintAsLandscape
        ...
        DocToPrint.DefaultPageSettings.Margins.Bottom = 100
    ...
    Public Sub DocToPrint_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles DocToPrint.BeginPrint
        ...
        lStringFormat = New StringFormat
        lStringFormat.Alignment = StringAlignment.Near
    ...
    Public Sub DocToPrint_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles DocToPrint.PrintPage
        ...
        Dim blFont As New Font("Arial", 8, FontStyle.Bold)
        ...
        Do While nRowPos < DataGridViewToPrint.Rows.Count
            ...
            Else
                ...
                If NewPage Then
                    ...
                    ' Draw Header
                    e.Graphics.DrawString(Header, IIf(IsInLandscape, blFont, New Font(DataGridViewToPrint.Font, FontStyle.Bold)), Brushes.Black, e.MarginBounds.Left, e.MarginBounds.Top - e.Graphics.MeasureString(Header, New Font(DataGridViewToPrint.Font, FontStyle.Bold), e.MarginBounds.Width).Height - 13)
                    ...
                    For Each oColumn As DataGridViewColumn In DataGridViewToPrint.Columns
                        If oColumn.Visible = True Then
                            ...
                            e.Graphics.DrawString(oColumn.HeaderText, IIf(IsInLandscape, blFont, oColumn.InheritedStyle.Font), New SolidBrush(oColumn.InheritedStyle.ForeColor), New RectangleF(oColumnLefts(i), nTop, oColumnWidths(i), nHeight), oStringFormat)
                            i += 1
                        End If
                ...
                For Each oCell As DataGridViewCell In oRow.Cells
                    Dim uformat As StringFormat = oStringFormat
                    If oCell.ColumnIndex = 0 Then uformat = lStringFormat
                    If oCell.Visible = True Then
                        If oColumnTypes(i) Is GetType(DataGridViewTextBoxColumn) OrElse oColumnTypes(i) Is GetType(DataGridViewLinkColumn) Then
                            Dim scellval As String = oCell.Value.ToString
                            'If oCell.ColumnIndex = 4 And scellval = "Yes" Then
                            '    scellval = "✔"
                            'End If
                            e.Graphics.DrawString(scellval, IIf(IsInLandscape, blFont, oCell.InheritedStyle.Font), New SolidBrush(oCell.InheritedStyle.ForeColor), New RectangleF(oColumnLefts(i), nTop, oColumnWidths(i), nHeight), uformat)
    ...
    Public Sub DrawFooter(ByVal e As System.Drawing.Printing.PrintPageEventArgs, ByVal RowsPerPage As Int32)
        ...
        e.Graphics.DrawString(sPageNo, DataGridViewToPrint.Font, Brushes.Black, e.MarginBounds.Left + (e.MarginBounds.Width - e.Graphics.MeasureString(sPageNo, DataGridViewToPrint.Font, e.MarginBounds.Width).Width), e.MarginBounds.Top + e.MarginBounds.Height + 25)
        ...
        ' Center - Page No. Info
        'e.Graphics.DrawString(sPageNo, DataGridViewToPrint.Font, Brushes.Black, e.MarginBounds.Left + (e.MarginBounds.Width - e.Graphics.MeasureString(sPageNo, DataGridViewToPrint.Font, e.MarginBounds.Width).Width) / 2, e.MarginBounds.Top + e.MarginBounds.Height + 22)
